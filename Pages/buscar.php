    ...
    <script>
        ...
        function showResults(str) {
            if (str.length >= 3) {
                ...
                xmlhttp.open("GET", "../Requests/getBooks.php?q=" + str, true);
                xmlhttp.send();
            }
        }
    </script>
...
<div class="container" style="width: -webkit-fill-available;margin: 0;max-width: -webkit-fill-available;">
    ...
    <div class="row justify-content-center" style="margin-top: 1rem;">
        <form class="form-inline my-2 my-lg-0">
            <input onkeypress="showResults(this.value)" class="form-control mr-sm-2" type="search"
                   placeholder="Busque por livros..." aria-label="Search">
        </form>
    </div>
